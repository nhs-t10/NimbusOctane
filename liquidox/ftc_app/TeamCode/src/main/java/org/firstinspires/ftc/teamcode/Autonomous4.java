...
public class Autonomous2 extends OpMode {
    ...
    public void rotate right 90 degrees{
        lf.setPower(0);
        lb.setPower(0);
        rf.setPower(1);
        rb.setPower(1);
    //    ADAM HELP WAIT 0.5 SECONDS;
        lf.setPower(0);
        lb.setPower(0);
        rf.setPower(0);
        rb.setPower(0);
    ...
    switch (step)
        ...
        case (2):
            ...
            break;
        case (3):
            forward (inchConversion(inches 32));
            step++;
            break;
        case (4):
            hookUp();
            ...
            break;
        case (5):
            right (inchConversion(inches 24));
            step++;
            break;
